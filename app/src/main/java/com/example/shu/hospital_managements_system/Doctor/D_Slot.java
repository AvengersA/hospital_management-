...
public class D_Slot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d__slot);
    ...
    public void onClick(View view) {
        ...
        if (y.moveToFirst()) {
            ...
            if (b) {
             //   com.example.shu.hospital_managements_system.Message.message(D_Slot.this, "Your Slot Has been Updated");
            } else {
             //   com.example.shu.hospital_managements_system.Message.message(D_Slot.this, "Some Error Occured, Try Again");
            }
        } else {
            boolean b = db.insert_slot(username, password, "", s, e, "Y");
            if (b) {
           //     com.example.shu.hospital_managements_system.Message.message(D_Slot.this, "Your Slot Has been Inserted");
            } else {
           //     com.example.shu.hospital_managements_system.Message.message(D_Slot.this, "Some Error Occured, Try Again");
            }
        }
