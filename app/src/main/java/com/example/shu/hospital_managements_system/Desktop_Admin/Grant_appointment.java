package com.example.shu.hospital_managements_system.Desktop_Admin;
...
import com.example.shu.hospital_managements_system.CustomListViewAdapter;
import com.example.shu.hospital_managements_system.DatabaseHelper;
import com.example.shu.hospital_managements_system.R;
import com.example.shu.hospital_managements_system.RowItem;
...
public class Grant_appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (y.moveToFirst()) {
           ...
           com.example.shu.hospital_managements_system.Message.message(Grant_appointment.this, "No Pending Apppointments");
            finish();
        }
        ...
        lv_appointment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (y) {
                    com.example.shu.hospital_managements_system.Message.message(Grant_appointment.this, "Application Approved");
                    finish();
                } else {
                    com.example.shu.hospital_managements_system.Message.message(Grant_appointment.this, "Not Approved");
                }
            }
        });
    }
