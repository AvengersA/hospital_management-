...
import static com.example.shu.hospital_managements_system.Message.message;
...
public class Assign_Staff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign__staff);
        ...
        b_assign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (z.moveToFirst()) {
                    com.example.shu.hospital_managements_system.Message.message(Assign_Staff.this, "Pair Already Assigned");
                } else {
                    boolean x = dbh.insert_staff(s_u.get(id_s), s_p.get(id_s), d_u.get(id_d), d_p.get(id_d), "Y");

                    if (x) {
                       com.example.shu.hospital_managements_system.Message.message(Assign_Staff.this, "Staff assigned");
                    } else {
                       com.example.shu.hospital_managements_system.Message.message(Assign_Staff.this, "Error occured");
                    }
                }
            }
        });
