...
public class Delete_Users extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete__users);
        ...
        if (!y.moveToFirst()) {
            com.example.shu.hospital_managements_system.Message.message(Delete_Users.this, "Sorry You have No users");
            finish();
        } else {
            while (true) {
        ...
        lv_all.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (by) {
                   com.example.shu.hospital_managements_system.Message.message(Delete_Users.this, "User Deleted");
                    finish();
                } else {
                    com.example.shu.hospital_managements_system.Message.message(Delete_Users.this, "User Cannot Be deleted Try again");
                }
            }
        });
    }
